...
Un fichier contenant le code principal, un fichier contenant les fonctions que nous avons définies, un fichier pour le score et enfin le fichier "Publipostage" qui n'est pas lié aux autres et sur lequel nous reviendrons un peu plus loin.
